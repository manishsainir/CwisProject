					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							...
							<li class="breadcrumb-item bcrumb-2"><a href="#"
								onClick="return false;">Reply Complaint</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="card">
						...
						<div class="body">
							...
							<f:form class="composeForm" modelAttribute="dataForReply"
								...
								<f:input path="complaintId" type="hidden" />
								<f:input path="complaintTime" type="hidden" />
								<f:input path="loginVO.loginId" type="hidden" />
								<f:input path="loginVO.username" type="hidden" />
								<f:input path="loginVO.password" type="hidden" />
								<f:input path="loginVO.role" type="hidden" />
								<f:input path="loginVO.enabled" type="hidden" />
								<f:input path="loginVO.status" type="hidden" />
								...
								<div class="form-group form-float">
									<div class="form-line">
										<f:textarea name="reply" cols="30" rows="5"
											class="form-control no-resize" required="" path="reply" />
										<label class="form-label">Reply</label>
									</div>
								</div>

								<button class="btn btn-primary waves-effect" type="submit">REPLY</button>
							</f:form>
						</div>
					</div>
				</div>
